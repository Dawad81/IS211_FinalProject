...
CREATE TABLE authors(user_id INTEGER PRIMARY KEY ASC, first_name TEXT, last_name TEXT, username TEXT, password TEXT);

CREATE TABLE blogpost (blog_id INTEGER PRIMARY KEY ASC, title TEXT, content INTEGER, date TEXT, category TEXT);

CREATE TABLE published(user_id INTEGER, blog_id INTEGER, published INTEGER);
